...
export function LettersPage() {
  ...
  useEffect(() => {
    if (passedAudit) {
      ...
      const hasFinancial = passedAudit.totalAmount > 3000;
      if (hasSurprise) {
  ...
  const letterContent = useMemo(() => {
    ...
    const replacements: Record<string, string> = {
      ...
      '[DATE_LIST]': passedAudit?.extractedData.allDates?.join(', ') || formData.dateOfService || '[DATES]',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <Badge variant="outline" className="text-green-600 bg-green-50 border-green-200">
                  <ShieldCheck className="h-3 w-3 mr-1" /> Locally Encrypted
                </Badge>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-2xl print:shadow-none print:border-none rounded-none border-t-4 border-t-primary">
              <CardContent className="p-12 font-serif leading-relaxed text-black bg-white min-h-[750px] relative" id="letter-preview">
                ...
                <div className="space-y-8">
                  ...
                  <div><p className="font-bold">{formData.name || "[PATIENT NAME]"}</p><p>[STREET ADDRESS]</p><p>[CITY, PA ZIP]</p></div>
                  <div className="pt-4"><p>Attn: Patient Billing Department</p><p className="font-bold">{formData.provider || "[PROVIDER NAME]"}</p></div>
                  <div className="pt-6 space-y-6">
                    ...
                    <div className="pt-12"><p>Sincerely,</p><p className="mt-8 font-bold border-t border-black w-48 pt-2">{formData.name || "[SIGNATURE]"}</p></div>
                  </div>
                </div>
              </CardContent>
            </Card>
